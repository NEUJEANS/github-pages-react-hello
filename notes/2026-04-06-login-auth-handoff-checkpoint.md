...
- Added a small frontend-only backend scaffold step: the form now prepares a `/api/auth/login` POST payload including the serializable guest draft snapshot and surfaces a ready-state message after submit.
