...
function buildMergedGuestAccountState(guestDraftSnapshot = null, persistedAccountState = null, { mergeResolution } = {}) {
  ...
  const layoutTrayItems = Array.isArray(continuity.layoutTrayItems)
  ...
  return {
    ...
    ...(Array.isArray(continuity.layoutTrayItems) || Array.isArray(baseState.layoutTrayItems) ? { layoutTrayItems } : {}),
